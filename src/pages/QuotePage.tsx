  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
              <div className="lg:col-span-2">
                <h1 className="font-display text-3xl md:text-5xl font-bold leading-tight">
                  Bereken je transportkosten of vraag een offerte aan
                </h1>
                ...
                <div className="mt-7 flex flex-wrap gap-3">
                  <Button size="lg" asChild className="bg-cta text-cta-foreground hover:bg-cta/90">
                    <a href="#offerte">Bereken transportkosten</a>
                  </Button>
        ...
        {/* Form sectie */}
        <section id="offerte" className="py-16 bg-muted/30">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Container­transport of grotere zendingen. Wij bekijken de beschikbare afvaarten en maken een offerte op maat.',
                },
                {
                  icon: Train,
